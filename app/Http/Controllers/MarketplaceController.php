...
class MarketplaceController extends Controller
{
    ...
    {
        $products = \App\Models\MarketplaceItem::where('is_available', true)
    ...
    public function purchase(Request $request)
    {
        ...
        $product = \App\Models\MarketplaceItem::find($request->product_id);
        ...
        if ($product->category === 'ai_access') {
            ...
            $duration = 7; 
            if (stripos($product->name, 'monthly') !== false) $duration = 30;
